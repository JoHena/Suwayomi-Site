...
In such cases, it will be helpful to have logs ready. You can find them in [The Data Directory](/docs/data-directory) in the logs directory.
...
- If the WebView errors: Go to [The Data Directory](/docs/data-directory) and remove the `bin` and `cache` folders.
...
- Delete the Suwayomi data directory located below and re-run the app. See [The Data Directory](/docs/data-directory) for information on how to find it.
